...
/* Napiste dotazy, ktere:
   	   	   1. Vrati tabulku se jmenem zamestnance a atributem low_salary, ktery bude obsahovat true, pokud plat zamestnance je pod 5000 a jinak false.
		   2. Vrati tabulku se jmenem zamestnance a atributem might_be s 10nĂˇsobkem jeho platu.
		   3. Zkuste v predchozuich dvou vysledcich urcit, ktere sloupce jsou aktualizovatelne a ktere ne. Overte pokusem.
		   4. Vrati tabulku se vsemi zamestnanci a jejich platem, kde radky budou setrizeny vzestupne podle platu a pote pripadne sestupne podle prijmeni zamestnance a pote pripadne sestupne podle jmena zamestnance.
		   5. Vrati tabulku s druhym az ctvrtym nejvyssim platem.
		   6. Vrati zamestannce kteri maji nektery z platu z predchoziho prikladu. Zkuste to s pouzitim vysledku predchoziho pripadu a operatoru IN. 
		   7. Vrati informace o velkem sefovi (profese 'President'). Zkuste to udelat tak, abyste nejprve nasli relaci obsahujici id presidenta (singelton) a ten pak pouzili jako hodnotu pro ziskani pozadovanych udaju.
...
INSERT INTO locations(location_id,street_address,postal_code,city,state_province,country_id) VALUES (2400,'8204 Arthur St','1234','London','London','UK');
...
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (145,'John','Russell','john.russell@sqltutorial.org','650.124.1224','1996-10-01',15,14000.00,100,8);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (146,'Karen','Partners','karen.partners@sqltutorial.org','650.124.1224','1997-01-05',15,13500.00,100,8);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (176,'Jonathon','Taylor','jonathon.taylor@sqltutorial.org','650.124.1224','1998-03-24',16,8600.00,100,8);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (177,'Jack','Livingston','jack.livingston@sqltutorial.org','650.124.1224','1998-04-23',16,8400.00,100,8);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (178,'Kimberely','Grant','kimberely.grant@sqltutorial.org','650.124.1224','1999-05-24',16,7000.00,100,8);
INSERT INTO employees(employee_id,first_name,last_name,email,phone_number,hire_date,job_id,salary,manager_id,department_id) VALUES (179,'Charles','Johnson','charles.johnson@sqltutorial.org','650.124.1224','2000-01-04',16,6200.00,100,8);
