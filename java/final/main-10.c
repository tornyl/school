...
public class Main{
	...
	public static String loadSequence(String path) throws IOException  {
			String output ="";
	...
	public static void saveResult(boolean append, String path, String result) throws IOException{
