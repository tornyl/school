...
;; Jak je napsáno v textu, následující primitivum není potřeba,
;; může se ale hodit

[lobby add "ME" :value #'identity]
...
[lobby add "RETURN-FIRST"
           :value {(arg1 arg2 var) [me set-var arg1]
                                   arg2 
                                   var}]
...
[lobby add "RETURN-FIRST"
           :value {(arg1 arg2) 
                     [[[object clone] add "METHOD" 
                                      :value {() [self add "VAR" :value arg1]
                                                 arg2
                                                 [self var]}]
                      method]}]
...
[lobby add "RETURN-FIRST"
           :value {(arg1 arg2) 
                     [[[{(method)} set-super object]
                          set-method {() [self add "VAR" :value arg1]
                                         arg2
                                         [self var]}]
                      method]}]
...
[object add "IS" 
        :value {(arg1) [object add "IS-MARK" :value false]
                       ...
                       [{} return-first [self is-mark]   ; místo lobby lze i {}
