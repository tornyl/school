		...
		return new Promise((resolve) => {
			...
			if (this.isAmpProject || this.isAmpIframe) {
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=115234&cbuster=1710918650&pubUrl=https://www.baeldung.com/linux/process-a-bash-variable-with-sed&x=400&y=272&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,809,1&cbuster=1710918650',
					origQString: 's=115234&cbuster=1710918650&pubUrl=https://www.baeldung.com/linux/process-a-bash-variable-with-sed&x=400&y=272&playerApiId=freestarPrimisPlayer&schain=1.0,1!freestar.com,809,1',
					placementId: 115234,
					x: 400,
					y: 272,
					videoType: 'flow',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Linux","osVersion":"","osVersionMajor":"0","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Firefox","browserType":"browser","browserVersion":"123.0","browserVersionMajor":"123","browserVersionMinor":"0","chromeVersion":""},"browser":"firefox","os":"linux","osVer":"","deviceType":"desktop","languages":["en"],"googlePSI":false},
					isFpCookie: 1,
					geo: 'CZ',
					dmaCode: 0,
					dynamicSetup: [],
